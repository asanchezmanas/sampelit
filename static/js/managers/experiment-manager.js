...
class ExperimentManager {
    ...
    async deleteExperiment(experimentId) {
        ...
        try {
            ...
            const response = await this.api.delete(`/experiments/${experimentId}`);
    ...
    async startExperiment(experimentId) {
        try {
            ...
            const response = await this.api.post(`/experiments/${experimentId}/start`);
    ...
    async pauseExperiment(experimentId) {
        try {
            ...
            const response = await this.api.post(`/experiments/${experimentId}/pause`);
    ...
    async stopExperiment(experimentId) {
        ...
        try {
            ...
            const response = await this.api.post(`/experiments/${experimentId}/stop`);
