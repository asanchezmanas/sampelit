...
### Por qué Holding + Operativa

1. **Protección**: Si la operativa quiebra, los activos en holding sobreviven
2. **Fiscalidad**: Dividendos intra-grupo pueden ser exentos (España: 95% exención)
3. **Exit**: Más fácil vender la operativa sin tocar inversiones
4. **Inversión**: La holding invierte el exceso de cash

---

## 💰 Fondo de Emergencia

### Regla: 12-18 meses de runway
...
| Categoría | % | Uso |
|-----------|---|-----|
| **40% - Reserva/Treasury** | 40% | Acumular hasta 18 meses runway, luego a inversiones |
| **30% - Reinversión Growth** | 30% | Ads, content, herramientas |
| **20% - Sueldo Personal** | 20% | Transferencia a cuenta personal |
| **10% - Inversiones Pasivas** | 10% | ETFs, REITs para generar dividendos |
...
| Instrumento | % Portfolio | Yield Esperado | Riesgo |
|-------------|-------------|----------------|--------|
...
## 🔐 Triggers y Decisiones

### Cuándo aumentar sueldo personal
...
## 🧮 Hoja de Cálculo Mental

### Métricas Clave (revisar mensual)
...
- [ ] Actualizar spreadsheet de portfolio
